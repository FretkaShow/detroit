...
netstream.Hook('dbg-hack.loaded', function()
	...
	print('Добро пожаловать VolleOS 17.03.24 LTS (GNU/Linux 4.15.0-29-generic x86_64)\n')
	print('* Документация в разработке')
	print('97 Пакеты могут быть обновлены.\n12 обновлений - это обновления безопасности.')
end)
