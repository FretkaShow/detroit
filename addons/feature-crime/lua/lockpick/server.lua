...
netstream.Hook('ice-lockpick.push', function(ply)
...
netstream.Hook('ice-lockpick', function(ply, ent, resp)
...
netstream.Hook('ice-lockpick.exploit', function(ply)
...
function ply:Lockpick(ent, data)
	...
	netstream.Start(self, 'ice-lockpick', ent, key, {
...
function ply:LockpickStop()
	...
	netstream.Start(self, 'ice-lockpick', nil)
