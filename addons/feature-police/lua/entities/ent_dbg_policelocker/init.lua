...
local mdls = {
	...
	female = {
		{ 'models/humans/voole/female01.mdl' },
		{ 'models/humans/voole/female02.mdl' },
		{ 'models/humans/voole/female03.mdl' },
		{ 'models/humans/voole/female06.mdl' },
		{ 'models/humans/voole/female07.mdl' },
