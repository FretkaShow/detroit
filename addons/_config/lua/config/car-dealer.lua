...
carDealer.civilSpawns = {
	...
	rp_evocity_rockford = {
        { Vector( -4585, -7538, 258), Angle(0,-90,0) },
        { Vector(-6650, -3753, 137), Angle(0,-90,0) },
        { Vector(-6843, -3728, 138), Angle(2,-90,0) },
        { Vector(-10331, -8382, 135), Angle(0,-1,0) }, 
        { Vector(-8660, 9371, 130), Angle(1,-90,0) },
        { Vector(-8889, 9396, 130), Angle(1,-91,0) },
    },
	rp_truenorth_v1a = {
	...
	rp_unioncity_day = {
        { Vector(5343, -2256, 5562), Angle(-0,90,0) },
        { Vector(1526, 1197, 5474), Angle(-0,90,0) },
        { Vector(-785, 7639, 5568), Angle(3,0,0) },
        { Vector(-1858, -3988, 5482), Angle(1,-0,0) },
        { Vector(1533, 10950, 5658), Angle(-0,-90,0) },
    },
}
...
carDealer.policeSpawns = {
	...
	rp_evocity_rockford = {
        { Vector(-427, 6145, 130), Angle(1,-0,0) }, -- pd
        { Vector(-435, 5984, 130), Angle(0,-0,0) },
        { Vector(-445, 5805, 130), Angle(0,-0,0) },
    },
	rp_truenorth_v1a = {
	...
	rp_unioncity_day = {
        { Vector(2751, -2274, 5474), Angle(4,88,0) },
        { Vector(2446, -2310, 5474), Angle(2,89,0) },
        { Vector(2136, -2309, 5474), Angle(0,91,0) },
    },
}
...
carDealer.tags = {
	dobro = {octolib.icons.silk16('heart'), 'Только для Добродеев', false},
