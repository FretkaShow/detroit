carDealer.addCategory('fire', {
	...
	spawns = {
		rp_evocity_rockford = {
			{ Vector(-1749, 3663, 130), Angle(-0,89,0) },
			{ Vector(-1449, 3664, 130), Angle(0,89,0) },
			{ Vector(-934, 2922, 130), Angle(1,178,0) },
		},
		...
		rp_unioncity_day = {
			{ Vector(4124, -1488, 5570), Angle(0, -1, 0) },
			{ Vector(4143, -1940, 5570), Angle(2, 0, 0) },
		},
	},
