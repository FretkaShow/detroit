...
local ranks = octolib.array.toKeys {'srg', 'lie', 'cap', 'ass', 'she', 'seb', 'det'}
carDealer.addCategory('wcso_nomark', {
	...
	spawns = {
        ...
        rp_evocity_dbg_230226 = {
			{ Vector(-3579, 8304, 130), Angle(4,-91,0) }, -- Duglas
			{ Vector(-3402, 8305, 130), Angle(1,-88,0) },
			{ Vector(-3163, 8318, 130), Angle(1,-88,0) },
			{ Vector(-2911, 8321, 130), Angle(2,-88,0) },
		},
