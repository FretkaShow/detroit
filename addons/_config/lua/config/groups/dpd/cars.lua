...
carDealer.addVeh('dpd-landstalker', {
	category = 'dpd',
	name = 'DPD Landstalker',
	simfphysID = 'sim_fphys_gta4_policelandstalker',
	price = 80000,
	deposit = true,
	police = true,
	radioWhitelist = carDealer.policeRadioStations,
...
carDealer.addCategory('nomark', {
	...
	spawns = {
		rp_evocity_dbg_220222 = {
			{ Vector(-8032, -9713, 130), Angle(1,-179,0) }, -- pd
			{ Vector(-8045, -9545, 130), Angle(1,179,0) },
			{ Vector(-8044, -9382, 130), Angle(2,-179,0) },
			{ Vector(-8034, -9215, 130), Angle(2,179,0) },
			{ Vector(-8037, -9049, 129), Angle(3,179,0) },
            { Vector(-8028, -8878, 130), Angle(2,179,0) },
            { Vector(-8034, -8716, 130), Angle(2,178,0) },
		},
