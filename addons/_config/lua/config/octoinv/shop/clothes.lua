...
local clothes = {
	...
	{ 2500, 'models/humans/modern/octo/standart14_sheet', 'octoteam/icons/clothes_jumper.png', 'Степной байкер', 'Зеленая клетчатая рубашка с черно-бежевым жилетом и черной футболкой, черные джинсы, коричневые ботинки' },
