...
-- SWEPS
--
octoinv.addShopItem('player', { cat = 'electronic', price = 1000 })
octoinv.addShopItem('phone', { cat = 'electronic', price = 700 })
octoinv.addShopItem('phone_st', { cat = 'electronic', price = 701 })
