...
--
 ...
 octoinv.addShopItem('ore_iron', { cat = 'resources', price = 200 })
 octoinv.addShopItem('ore_steel', { cat = 'resources', price = 200 })
 octoinv.addShopItem('ore_silver', { cat = 'resources', price = 350 })
 octoinv.addShopItem('ore_bronze', { cat = 'resources', price = 200 })
 octoinv.addShopItem('ore_gold', { cat = 'resources', price = 550 })
 octoinv.addShopItem('ore_copper', { cat = 'resources', price = 150 })
 octoinv.addShopItem('sulfur', { cat = 'resources', price = 100 })
 octoinv.addShopItem('craft_coal', { cat = 'resources', price = 200 })
