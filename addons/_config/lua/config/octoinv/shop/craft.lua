...
octoinv.addShopItem('tool_screwer', { cat = 'tool', price = 250 })
octoinv.addShopItem('tool_hammer', { cat = 'tool', price = 150 })
octoinv.addShopItem('tool_wrench', { cat = 'tool', price = 300 })
octoinv.addShopItem('tool_solder', { cat = 'tool', price = 450 })
octoinv.addShopItem('tool_ruler', { cat = 'tool', price = 10 })
octoinv.addShopItem('tool_caliper', { cat = 'tool', price = 250 })
octoinv.addShopItem('tool_pump', { cat = 'tool', price = 400 })
octoinv.addShopItem('tool_knife_stanley', { cat = 'tool', price = 50 })
octoinv.addShopItem('tool_drill', { cat = 'tool', price = 1000 })
octoinv.addShopItem('tool_saw', { cat = 'tool', price = 150 })
...
octoinv.addShopItem('craft_sheet', { cat = 'build', price = 400 })
...
octoinv.addShopItem('craft_engine', { cat = 'build', price = 200 })
...
octoinv.addShopItem('bpd_stove', { cat = 'parts', price = 2000 })
octoinv.addShopItem('bpd_fridge', { cat = 'parts', price = 2000 })
octoinv.addShopItem('bpd_refinery', { cat = 'parts', price = 4000 })
octoinv.addShopItem('bpd_smelter', { cat = 'parts', price = 3000 })
octoinv.addShopItem('bpd_machine', { cat = 'parts', price = 2500 })
octoinv.addShopItem('bpd_workbench', { cat = 'parts', price = 1500 })
