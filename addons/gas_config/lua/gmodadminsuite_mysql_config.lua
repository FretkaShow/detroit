...
GAS.Config.MySQL.Password = "u1256_rirs5Jd6NI"

-- The name of the MySQL database
GAS.Config.MySQL.Database = "s1256_dbg"

-- Give your server a friendly nickname, this allows you to identify it easily
-- on external systems and panels.
GAS.Config.MySQL.ServerNickname = "OUTSIDER"
