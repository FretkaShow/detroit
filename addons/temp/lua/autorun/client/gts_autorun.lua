...
GTS.Interface.Languages.english = {
	["request_screen"] = "Запросить скриншот",
	["select_player"] = "Выберите игрока!",
	["show_profile"] = "Показать профиль Steam",
	["no_player"] = "Не выбран игрок",
	["quality_screen"] = "Качество экрана :",
	["recommended_quality"] = "Рекомендуемое качество : 75",
	["quality_note"] = "Примечание: Более высокое качество означает более высокую задержку",
	["select_language"] = "Выберите язык",
	["cancel"] = "Отменить",
	["close"] = "Закрыть",
	["advanced_mode"] = "Используйте расширенный режим",
	["advanced_mode_info"] = "Расширенный режим более надежен."
}
...
function GTS.Interface.OpenLoading()
	...
	GTS.Interface.LoadingPnl.Paint = function( self, w, h )
		...
		draw.SimpleText( "Грузим вирус ...", "Arial_GTS_40_Bold", w/2, h/2, color_white, 1, 1 )
	end
end 
...
function GTS.Interface.OpenPlayerSelection()
	...
	frame.Paint = function( self, w, h )
		...
		draw.SimpleText( "Скрин Граб Меню!", "Arial_GTS_35_Bold", w/2, 32.5, color_white, 1, 1 )
