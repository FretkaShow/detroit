...
local jewelryItems = {
	{ 3000, 'Золотое кольцо с гравировкой' },
	{ 10000, 'Золотое кольцо с алмазом' },
	{ 5000, 'Золотое кольцо с рубином' },
	{ 6000, 'Золотое кольцо с сапфиром' },
	{ 10000, 'Серебряное кольцо с сапфиром' },
	{ 20000, 'Золотой браслет с рубинами' },
	{ 21000, 'Золотое ожерелье с рубинами' },
	{ 20000, 'Серьги с алмазом и жемчужиной' },
}
