...
octoinv.addShopItem('jewelry_pearl', { cat = 'jewelry', price = 3000 })
octoinv.addShopItem('jewelry_diamond', { cat = 'jewelry', price = 5000 })
octoinv.addShopItem('jewelry_ruby', { cat = 'jewelry', price = 6000 })
octoinv.addShopItem('jewelry_sapphire', { cat = 'jewelry', price = 6000 })
octoinv.addShopItem('jewelry_topaz', { cat = 'jewelry', price = 8000 })
octoinv.addShopItem('jewelry_emerald', { cat = 'jewelry', price = 8500 })
