...
local maps = {
	...
	evocity = Vector(-7663.283691, -7756.793945, 560),
	evocityadminbase2 = Vector(-2125.184082, -11752.296875, 129.205658),
...
local maps = {
	evocity = Vector(-2056.892578, -11744.648438, 128.031250),
}
