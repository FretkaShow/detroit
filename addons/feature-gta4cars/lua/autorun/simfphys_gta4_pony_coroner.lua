...
list.Set('simfphys_vehicles', 'sim_fphys_gta4_pony_coroner', V )
...
--[[			{
	...
	ems_sprites = {{
		...
		pos = Vector(-102.7, -24.9, 46),
		material = 'sprites/light_glow02_add_noz',
		size = 80,
		Colors = {Color(120,60,0,255),Color(0,0,0,255),Color(0,0,0,255),Color(0,0,0,255)},
		Speed = 0.15,
	}, {
		pos = Vector(-102.7, -8.0, 46),
		material = 'sprites/light_glow02_add_noz',
		size = 80,
		Colors = {Color(0,0,0,255),Color(0,0,0,255),Color(120,60,0,255),Color(0,0,0,255)},
		Speed = 0.15,
...
list.Set('simfphys_lights', 'gta4_pony_coroner', light_table)