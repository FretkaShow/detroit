local V = {
	Name = 'Tow Truck',
	Model = 'models/octoteam/vehicles/bobcat_towtruck.mdl',
	Class = 'gmod_sent_vehicle_fphysics_base',
	Category = 'Los Santos - Сервис',
	...
	Members = {
		...
		LightsTable = 'gta4_bobcat_towtruck',
...
list.Set('simfphys_vehicles', 'sim_fphys_gta4_bobcat_towtruck', V )
...
list.Set('simfphys_lights', 'gta4_bobcat_towtruck', light_table)