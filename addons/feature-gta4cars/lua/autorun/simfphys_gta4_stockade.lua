local V = {
	Name = 'Stockade',
	Model = 'models/octoteam/vehicles/stockade.mdl',
	...
	Members = {
		...
		CustomWheelModel = 'models/octoteam/vehicles/stockade_wheel.mdl',
		CustomWheelModel_R = 'models/octoteam/vehicles/stockade_wheel_r.mdl',
		...
		Plates = {
			Front = { pos = Vector(140.41, 0.014, 4.973), ang = Angle(0.0, 0.0, 0.0) },
