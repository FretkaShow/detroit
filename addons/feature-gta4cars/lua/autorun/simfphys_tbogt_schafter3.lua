local V = {
	...
	Model = 'models/octoteam/vehicles/schafter3.mdl',
	...
	Members = {
		...
		OnSpawn = function(ent)
			...
			if (ProxyColor ) then
				...
				-- CarCols[19] = {REN.GTA4ColorTable(13,133,80)}
		...
		CustomWheelModel = 'models/octoteam/vehicles/schafter3_wheel.mdl',
		...
		ExhaustPositions = {
			{
				pos = Vector(-112,19,-11.5),
				ang = Angle(-90,0,0),
			},
			{
				pos = Vector(-113,14,-11.5),
				ang = Angle(-90,0,0),
			},
			{
				pos = Vector(-112,-19,-11.5),
